...
#ifndef __mast_plate_flag_euler_fsi_flutter_h__
#define __mast_plate_flag_euler_fsi_flutter_h__
...
namespace MAST {
    ...
    struct PlateFlagEulerFSIFlutterAnalysis:
    public libMesh::ParallelObject {
        ...
        ~PlateFlagEulerFSIFlutterAnalysis();
...
#endif //  __mast_plate_flag_euler_fsi_flutter_h__
