...
//
//// MAST includes
//#include "examples/structural/stiffened_plate_optimization/stiffened_plate_optimization.h"
...
//
//void
//stiffened_plate_optim_obj(int*    mode,
//                          int*    n,
//                          double* x,
//                          double* f,
//                          double* g,
...
//
//void
//stiffened_plate_optim_con(int*    mode,
//                          int*    ncnln,
//                          int*    n,
//                          int*    ldJ,
//                          int*    needc,
...
//StiffenedPlateBendingSizingOptimization(const libMesh::Parallel::Communicator& comm):
...
//
//void
//MAST::StiffenedPlateBendingSizingOptimization::init(GetPot& infile,
...
//
//
//MAST::StiffenedPlateBendingSizingOptimization::~StiffenedPlateBendingSizingOptimization() {
//    
//    
//    if (_initialized) {
//        delete _m_card;
...
//
//void
//MAST::StiffenedPlateBendingSizingOptimization::init_dvar(std::vector<Real>& x,
...
//
//void
//MAST::StiffenedPlateBendingSizingOptimization::evaluate(const std::vector<Real>& dvars,
//                                                        Real& obj,
//                                                        bool eval_obj_grad,
...
//
//void
//MAST::StiffenedPlateBendingSizingOptimization::clear_stresss() {
//    
//    // iterate over the output quantities and delete them
//    std::vector<MAST::StressStrainOutputBase*>::iterator
//    it   =   _outputs.begin(),
...
//
//void
//MAST::StiffenedPlateBendingSizingOptimization::output(unsigned int iter,
...
//MAST::StiffenedPlateBendingSizingOptimization::get_objective_evaluation_function() {
//    
//    return stiffened_plate_optim_obj;
//}
//
//
//
//MAST::FunctionEvaluation::funcon
//MAST::StiffenedPlateBendingSizingOptimization::get_constraint_evaluation_function() {
//    
//    return stiffened_plate_optim_con;
//}
//
