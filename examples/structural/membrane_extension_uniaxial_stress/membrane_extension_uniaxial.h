...
#ifndef __mast_membrane_extension_uniaxial_h__
#define __mast_membrane_extension_uniaxial_h__
...
namespace MAST {
    ...
    struct MembraneExtensionUniaxial {
        
        
        MembraneExtensionUniaxial();
...
#endif //  __mast_membrane_extension_uniaxial_h__
