...
#ifndef __mast_beam_bending_thermal_stress_optimization_h__
#define __mast_beam_bending_thermal_stress_optimization_h__
...
#endif /* __mast_beam_bending_thermal_stress_optimization_h__ */
