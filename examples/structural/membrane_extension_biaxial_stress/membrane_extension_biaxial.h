...
#ifndef __mast_membrane_extension_biaxial_h__
#define __mast_membrane_extension_biaxial_h__
...
namespace MAST {
    ...
    struct MembraneExtensionBiaxial {
        
        
        MembraneExtensionBiaxial();
...
#endif //  __mast_membrane_extension_biaxial_h__
