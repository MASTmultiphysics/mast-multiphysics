...
#ifndef __mast_bar_steady_state_conduction_h__
#define __mast_bar_steady_state_conduction_h__
...
namespace MAST {
    ...
    struct BarSteadyState {
        ...
        MAST::HeatConductionDiscipline*           _discipline;
        ...
        *_q_source_f;
        ...
        MAST::BoundaryConditionBase*             _q_source_load;
...
#endif //  __mast_bar_steady_state_conduction_h__
