...
//
//void
//beam_euler_flutter_optim_obj(int*    mode,
//                             int*    n,
//                             double* x,
//                             double* f,
//                             double* g,
...
//
//void
//beam_euler_flutter_optim_con(int*    mode,
//                             int*    ncnln,
//                             int*    n,
//                             int*    ldJ,
//                             int*    needc,
...
//
//void
//MAST::BeamFSIFlutterSizingOptimization::init_dvar(std::vector<Real>& x,
...
//
//void
//MAST::BeamFSIFlutterSizingOptimization::evaluate(const std::vector<Real>& dvars,
//                                                 Real& obj,
//                                                 bool eval_obj_grad,
...
//
//void
//MAST::BeamFSIFlutterSizingOptimization::output(unsigned int iter,
...
//MAST::BeamFSIFlutterSizingOptimization::get_objective_evaluation_function() {
//
//    return beam_euler_flutter_optim_obj;
//}
//
//
//
//MAST::FunctionEvaluation::funcon
//MAST::BeamFSIFlutterSizingOptimization::get_constraint_evaluation_function() {
//
//    return beam_euler_flutter_optim_con;
//}
//
