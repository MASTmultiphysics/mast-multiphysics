...
#ifndef __mast__plate_flag_pressure_function_h__
#define __mast__plate_flag_pressure_function_h__
...
namespace MAST {
    ...
    class PlateFlagPressureFunction:
    ...
    public:
        ...
        virtual ~PlateFlagPressureFunction();
...
#endif // __mast__plate_flag_pressure_function_h__
