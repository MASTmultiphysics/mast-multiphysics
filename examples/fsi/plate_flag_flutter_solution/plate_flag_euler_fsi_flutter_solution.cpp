...
//#include "examples/fsi/plate_flag_flutter_solution/plate_flag_frequency_domain_normal_rotation.h"
...
//
//
//MAST::PlateFlagEulerFSIFlutterAnalysis::
//PlateFlagEulerFSIFlutterAnalysis(const libMesh::Parallel::Communicator& comm_in):
...
//    
//    _pressure_function =
//    new MAST::PlateFlagPressureFunction(*_fluid_sys_init,
//                                        *_flight_cond,
//                                        thickness);
//    _freq_domain_pressure_function =
//    new MAST::PlateFlagFrequencyDomainPressureFunction(*_fluid_sys_init,
//                                                       *_flight_cond,
//                                                       thickness);
//    
...
//    _displ        =
//    new MAST::PlateFlagFrequencyDomainDisplacement(*_structural_sys_init,
//                                                   "frequency_domain_displacement");
//    _normal_rot   =
//    new MAST::PlateFlagFrequencyDomainNormalRotation("frequency_domain_normal_rotation",
//                                                     *_displ);
...
//
//
//MAST::PlateFlagEulerFSIFlutterAnalysis::~PlateFlagEulerFSIFlutterAnalysis() {
//    
...
//
//Real
//MAST::PlateFlagEulerFSIFlutterAnalysis::solve(bool if_write_output,
//                                              const Real tol,
...
//
//Real
//MAST::PlateFlagEulerFSIFlutterAnalysis::sensitivity_solve(MAST::Parameter& p) {
//    
//    /*
//     // create the nonlinear assembly object
