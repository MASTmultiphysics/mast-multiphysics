...
MAST::PlateFlagFrequencyDomainNormalRotation::
...
void
MAST::PlateFlagFrequencyDomainNormalRotation::operator()(const libMesh::Point& p,
...
void
MAST::PlateFlagFrequencyDomainNormalRotation::perturbation(const libMesh::Point& p,
                                                          const libMesh::Point& n,
                                                          const Real t,
                                                          ComplexVectorX& dn_rot) const {
