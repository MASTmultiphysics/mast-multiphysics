...
//
//
//MAST::BeamEulerFSIAnalysis::BeamEulerFSIAnalysis(const libMesh::Parallel::Communicator& comm_in):
...
//    fluid_assembly.set_discipline_and_system(fluid_elem_ops,
//                                                *_fluid_discipline,
...
//    
//    // create the nonlinear assembly object
//    structural_assembly.set_discipline_and_system(structural_elem_ops,
...
//                                                 *_pressure_function);
//    
//    MAST::MultiphysicsNonlinearSolverBase fsi_solver(this->comm(), "fsi", 2);
//
//    
