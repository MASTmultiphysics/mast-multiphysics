...
if (NOT timpi_opt_LIBRARY)
    if (NOT timpi_dev_LIBRARY)
        if (NOT timpi_dbg_LIBRARY)
            MESSAGE(FATAL_ERROR "Could not locate any timpi library!")
        else()
            MESSAGE(WARNING "Did not find timpi_opt or timpi_dev, using timpi_dbg for optimized version.")
            SET(timpi_opt_LIBRARY ${timpi_dbg_LIBRARY})
        endif()
    else()
        MESSAGE(WARNING "Did not find timpi_opt, using timpi_dev for optimized version.")
        SET(timpi_opt_LIBRARY ${timpi_dev_LIBRARY})
    endif()
endif()
...
if (NOT timpi_dev_LIBRARY)
    if (NOT timpi_dbg_LIBRARY)
        if (NOT timpi_opt_LIBRARY)
            ...
            MESSAGE(WARNING "Did not find timpi_dev or timpi_dbg, using timpi_opt for development version.")
            SET(timpi_dev_LIBRARY ${timpi_opt_LIBRARY})
        endif()
    else()
        MESSAGE(WARNING "Did not find timpi_dev, using timpi_dbg for development version.")
        SET(timpi_dev_LIBRARY ${timpi_dbg_LIBRARY})
    endif()
endif()
...
if (NOT timpi_dbg_LIBRARY)
    if (NOT timpi_dev_LIBRARY)
        if (NOT timpi_opt_LIBRARY)
            ...
            MESSAGE(WARNING "Did not find timpi_dbg or timpi_dev, using timpi_opt for debug version.")
            SET(timpi_dbg_LIBRARY ${timpi_opt_LIBRARY})
        endif()
    else()
        MESSAGE(WARNING "Did not find timpi_dbg, using timpi_dev for debug version.")
        SET(timpi_dbg_LIBRARY ${timpi_dev_LIBRARY})
    endif()
endif()
