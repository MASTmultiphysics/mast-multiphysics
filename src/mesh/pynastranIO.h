...
#ifndef __PYX_HAVE__pynastranIO
...
#ifndef __PYX_HAVE_API__pynastranIO
...
#endif /* !__PYX_HAVE_API__pynastranIO */

/* WARNING: the interface of the module init function changed in CPython 3.5. */
/* It now returns a PyModuleDef instance instead of a PyModule instance. */

#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initpynastranIO(void);
#else
PyMODINIT_FUNC PyInit_pynastranIO(void);
#endif

#endif /* !__PYX_HAVE__pynastranIO */
