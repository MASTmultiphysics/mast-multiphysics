...
namespace MAST {
    ...
    public:
        ...
        virtual void clear_assembly() override;
    ...
    protected:
        ...
        bool _dofUsedInitialized = false;
        std::vector<bool> _dofUsed; // Keeps tracks fo what sensitivities have already been output through elements
    };
}
