...
#ifndef __mast__first_mass_moments_of_inertia_output__
#define __mast__first_mass_moments_of_inertia_output__
...
namespace MAST {
    ...
    /*!
     *   Computes the first_mass_moments_of_inertia.
     */
    class FirstMassMomentsOfInertiaOutput:
    ...
    public:
         ...
         *    default constructor
         */
        FirstMassMomentsOfInertiaOutput();
        
        virtual ~FirstMassMomentsOfInertiaOutput();
    ...
    protected:
        ...
        Real _first_moment_of_inertia_yz, _first_moment_of_inertia_xz, _first_moment_of_inertia_xy;
        Real _dfirst_moment_of_inertia_yz_dp, _dfirst_moment_of_inertia_xz_dp, _dfirst_moment_of_inertia_xy_dp;
        RealVectorX _first_mass_moments_of_inertia;
        RealVectorX _dfirst_mass_moments_of_inertia_dp;
    };
}

#endif // __mast__first_mass_moments_of_inertia_output__
