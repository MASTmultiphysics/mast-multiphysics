...
#ifndef __mast__smooth_ramp_stress_output__
#define __mast__smooth_ramp_stress_output__
...
namespace MAST {
    ...
    /*!
     *   This implements the computation of smooth ramp constraint aggregation
...
#endif // __mast__smooth_ramp_stress_output__
