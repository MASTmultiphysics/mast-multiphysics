...
#ifndef __mast__mass_products_of_inertia_output__
#define __mast__mass_products_of_inertia_output__
...
namespace MAST {
    ...
    /*!
     *   Computes the mass_products_of_inertia.
     */
    class MassProductsOfInertiaOutput:
    ...
    public:
         ...
         *    default constructor
         */
        MassProductsOfInertiaOutput();
        
        virtual ~MassProductsOfInertiaOutput();
    ...
    protected:
        ...
        Real _product_of_inertia_xy, _product_of_inertia_yz, _product_of_inertia_zx;
        Real _dproduct_of_inertia_xy_dp, _dproduct_of_inertia_yz_dp, _dproduct_of_inertia_zx_dp;
        RealVectorX _mass_products_of_inertia;
        RealVectorX _dmass_products_of_inertia_dp;
    };
}

#endif // __mast__mass_products_of_inertia_output__
