...
class StrainEnergy:
public FEComputeKernel<typename Traits::res_vector_type, Traits, ContextType> {
...
public:
    ...
    StrainEnergy():
    MAST::FEComputeKernel<value_type, Traits, ContextType>("strain_energy"),
    _material    (nullptr),
    ...
    virtual inline void
    set_material(const MAST::ComputeKernel<material_value_type, ContextType>& material)
    { _material = &material;}
    ...
    virtual inline value_type value(ContextType& c) const override { }
    
protected:
    
    
    const MAST::ComputeKernel<material_value_type, ContextType> *_material;
