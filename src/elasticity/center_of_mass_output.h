...
#ifndef __mast__center_of_mass_output__
#define __mast__center_of_mass_output__
...
namespace MAST {
    ...
    /*!
     *   Computes the center_of_mass.
     */
    class CenterOfMassOutput:
    ...
    protected:
        ...
        Real _first_moment_of_inertia_yz, _first_moment_of_inertia_xz, _first_moment_of_inertia_xy, _mass;
        Real _dfirst_moment_of_inertia_yz_dp, _dfirst_moment_of_inertia_xz_dp, _dfirst_moment_of_inertia_xy_dp, _dmass_dp;
        RealVectorX _center_of_mass;
        RealVectorX _dcenter_of_mass_dp;
    };
}
