...
#ifndef __mast__second_mass_moments_of_inertia_output__
#define __mast__second_mass_moments_of_inertia_output__
...
namespace MAST {
    ...
    /*!
     *   Computes the second_mass_moments_of_inertia.
     */
    class SecondMassMomentsOfInertiaOutput:
    ...
    public:
         ...
         *    default constructor
         */
        SecondMassMomentsOfInertiaOutput();
        
        virtual ~SecondMassMomentsOfInertiaOutput();
        ...
        virtual Real output_total() {
            libmesh_error_msg("For the method \"" << __PRETTY_FUNCTION__ << "\", you should use \"output_vector_total()\" instead.; In " << __FILE__ << " at line number " << __LINE__);
        }

        /*!
         *   @returns the output vector quantity value accumulated over all elements
         */
        virtual RealVectorX output_vector_total();
        ...
        virtual Real output_sensitivity_total(const MAST::FunctionBase& p) {
            libmesh_error_msg("For the method \"" << __PRETTY_FUNCTION__ << "\", you should use \"output_vector_sensitivity_total()\" instead.; In " << __FILE__ << " at line number " << __LINE__);
        }


        /*!
         *   @returns the output vector quantity sensitivity for parameter.
         *   This method calculates the partial derivative of quantity
         *    \f[ \frac{\partial q(X, p)}{\partial p} \f]  with
         *    respect to parameter \f$ p \f$. This returns the quantity
         *   accumulated over all elements.
         */
        virtual RealVectorX output_vector_sensitivity_total(const MAST::FunctionBase& p);
    ...
    protected:
        ...
        Real _second_mass_moment_of_inertia_xx, _second_mass_moment_of_inertia_yy, _second_mass_moment_of_inertia_zz;
        Real _dsecond_mass_moment_of_inertia_xx_dp, _dsecond_mass_moment_of_inertia_yy_dp, _dsecond_mass_moment_of_inertia_zz_dp;
        RealVectorX _second_mass_moments_of_inertia;
        RealVectorX _dsecond_mass_moments_of_inertia_dp;
    };
}

#endif // __mast__second_mass_moments_of_inertia_output__
