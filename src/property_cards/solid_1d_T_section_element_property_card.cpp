...
// MAST includes
#include "property_cards/solid_1d_T_section_element_property_card.h"

// Unequal T-Beam (T in Siemens NX Nastran and Astros 21.2)
void MAST::Solid1DTSectionProperty::calcA(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& A){
    A = DIM1*DIM3+DIM4*(DIM2-DIM3);
}

void MAST::Solid1DTSectionProperty::calcdA(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dA){
    dA = DIM3*dDIM1+DIM4*dDIM2+dDIM3*(DIM1-DIM4)+dDIM4*(DIM2-DIM3);
}

void MAST::Solid1DTSectionProperty::calcIz(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& Iz){
...
void MAST::Solid1DTSectionProperty::calcdIz(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dIz){
...
void MAST::Solid1DTSectionProperty::calcIy(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& Iy){
    Iy = ((DIM1*DIM1*DIM1)*DIM3)/1.2E+1+((DIM4*DIM4*DIM4)*(DIM2-DIM3))/1.2E+1;
}

void MAST::Solid1DTSectionProperty::calcdIy(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dIy){
...
void MAST::Solid1DTSectionProperty::calcIp(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& Ip){
    Ip = (DIM1*(DIM3*DIM3*DIM3))/1.2E+1+((DIM1*DIM1*DIM1)*DIM3)/1.2E+1+(DIM4*pow(DIM2-DIM3,3.0))/1.2E+1+((DIM4*DIM4*DIM4)*(DIM2-DIM3))/1.2E+1+DIM4*(DIM2-DIM3)*pow(DIM2/2.0-(DIM2*DIM4*(DIM2-DIM3))/(DIM1*DIM3*2.0+DIM4*(DIM2-DIM3)*2.0),2.0)+DIM1*(DIM2*DIM2)*DIM3*(DIM4*DIM4)*1.0/pow(DIM1*DIM3*2.0+DIM4*(DIM2-DIM3)*2.0,2.0)*pow(DIM2-DIM3,2.0);
}

void MAST::Solid1DTSectionProperty::calcdIp(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dIp){
...
void MAST::Solid1DTSectionProperty::calcJ1_w(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& J1_w){
    J1_w = (DIM4*DIM4*DIM4)*(DIM2-DIM3);
}

void MAST::Solid1DTSectionProperty::calcdJ1_w(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dJ1_w){
    dJ1_w = (DIM4*DIM4*DIM4)*dDIM2-(DIM4*DIM4*DIM4)*dDIM3+(DIM4*DIM4)*dDIM4*(DIM2-DIM3)*3.0;
}

void MAST::Solid1DTSectionProperty::calcJ2_w(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& J2_w){
    J2_w = DIM4*pow(DIM2-DIM3,3.0);
}

void MAST::Solid1DTSectionProperty::calcdJ2_w(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dJ2_w){
    dJ2_w = pow(DIM2-DIM3,2.0)*(DIM2*dDIM4+DIM4*dDIM2*3.0-DIM3*dDIM4-DIM4*dDIM3*3.0);
}

void MAST::Solid1DTSectionProperty::calcJ1_f(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& J1_f){
    J1_f = DIM1*(DIM3*DIM3*DIM3);
}

void MAST::Solid1DTSectionProperty::calcdJ1_f(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dJ1_f){
    dJ1_f = (DIM3*DIM3*DIM3)*dDIM1+DIM1*(DIM3*DIM3)*dDIM3*3.0;
}

void MAST::Solid1DTSectionProperty::calcJ2_f(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& J2_f){
    J2_f = (DIM1*DIM1*DIM1)*DIM3;
}

void MAST::Solid1DTSectionProperty::calcdJ2_f(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dJ2_f){
    dJ2_f = (DIM1*DIM1*DIM1)*dDIM3+(DIM1*DIM1)*DIM3*dDIM1*3.0;
}

void MAST::Solid1DTSectionProperty::calck1_f(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& k1_f){
    k1_f = 1.0/3.0;
}

void MAST::Solid1DTSectionProperty::calcdk1_f(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dk1_f){
    dk1_f = 0.0;
}

void MAST::Solid1DTSectionProperty::calck2_f(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& k2_f){
    k2_f = 1.0/3.0;
}

void MAST::Solid1DTSectionProperty::calcdk2_f(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dk2_f){
    dk2_f = 0.0;
}

void MAST::Solid1DTSectionProperty::calck1_w(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& k1_w){
    k1_w = 1.0/3.0;
}

void MAST::Solid1DTSectionProperty::calcdk1_w(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dk1_w){
    dk1_w = 0.0;
}

void MAST::Solid1DTSectionProperty::calck2_w(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& k2_w){
    k2_w = 1.0/3.0;
}

void MAST::Solid1DTSectionProperty::calcdk2_w(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dk2_w){
    dk2_w = 0.0;
}

void MAST::Solid1DTSectionProperty::calcJc(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& Jc){
...
void MAST::Solid1DTSectionProperty::calcdJc(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dJc){
...
void MAST::Solid1DTSectionProperty::calcJ(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& J)
{
    Real t_f = DIM3;
    Real w_f = DIM1;
    Real h_w = DIM2-DIM3;
...
void MAST::Solid1DTSectionProperty::calcdJ(Real& DIM1, Real& DIM2, Real& DIM3, Real& DIM4, Real& dDIM1, Real& dDIM2, Real& dDIM3, Real& dDIM4, Real& dJ)
{
    Real t_f = DIM3;
    Real w_f = DIM1;
    Real h_w = DIM2-DIM3;
...
void MAST::Solid1DTSectionElementPropertyCard::init() {
    ...
    _A.reset(new MAST::Solid1D4ParameterSectionProperty::Area(MAST::Solid1DTSectionProperty::calcA,
                                                              MAST::Solid1DTSectionProperty::calcdA,
                                                              DIM1, DIM2, DIM3, 
                                                              DIM4));
    
    _Ay.reset(new MAST::Solid1D4ParameterSectionProperty::AreaYMoment(
                                                                MAST::Solid1DTSectionProperty::calcA,
                                                                MAST::Solid1DTSectionProperty::calcdA,
                                                                DIM1, DIM2, 
                                                                DIM3, DIM4,
                                                                hz_off));
    ...
    _J.reset(new MAST::Solid1D4ParameterSectionProperty::TorsionalConstant(
                                                                MAST::Solid1DTSectionProperty::calcJ,
                                                                MAST::Solid1DTSectionProperty::calcdJ,
                                                                DIM1, DIM2,
                                                                DIM3, DIM4));
    
    _Ip.reset(new MAST::Solid1D4ParameterSectionProperty::PolarInertia(
                                                                MAST::Solid1DTSectionProperty::calcIp,
                                                                MAST::Solid1DTSectionProperty::calcdIp,
                                                                MAST::Solid1DTSectionProperty::calcA,
                                                                MAST::Solid1DTSectionProperty::calcdA,
                                                                DIM1, DIM2,
                                                                DIM3, DIM4,
    ...
    _AI.reset(new MAST::Solid1D4ParameterSectionProperty::AreaInertiaMatrix(
                                                                MAST::Solid1DTSectionProperty::calcIz,
                                                                MAST::Solid1DTSectionProperty::calcdIz,
                                                                MAST::Solid1DTSectionProperty::calcIy,
                                                                MAST::Solid1DTSectionProperty::calcdIy,
                                                                MAST::Solid1DTSectionProperty::calcA,
                                                                MAST::Solid1DTSectionProperty::calcdA,
                                                                DIM1, DIM2,
                                                                DIM3, DIM4,
