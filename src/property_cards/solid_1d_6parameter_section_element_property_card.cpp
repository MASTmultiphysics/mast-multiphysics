...
_DIM4(DIM4), _DIM5(DIM5), _DIM6(DIM6){
...
void MAST::Solid1D6ParameterSectionProperty::Area::
operator() (const libMesh::Point& p, const Real t, Real& m) const 
{
    Real DIM1, DIM2, DIM3, DIM4, DIM5, DIM6;
    _DIM1(p, t, DIM1);
    _DIM2(p, t, DIM2);
    _DIM3(p, t, DIM3);
    _DIM4(p, t, DIM4);
    _DIM5(p, t, DIM5);
    _DIM6(p, t, DIM6);
    _func(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, m);
}
           ...
           Real& m) const 
{
    ...
    _dfunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, 
           dDIM1, dDIM2, dDIM3, dDIM4, dDIM5, dDIM6, m);
}


MAST::Solid1D6ParameterSectionProperty::TorsionalConstant::
...
void MAST::Solid1D6ParameterSectionProperty::TorsionalConstant::
operator() (const libMesh::Point& p, const Real t, Real& m) const 
{
    Real DIM1, DIM2, DIM3, DIM4, DIM5, DIM6;
    _DIM1(p, t, DIM1);
...
Real& m) const 
{
    ...
    _DIM5(p, t, DIM5); _DIM5.derivative( f, p, t, dDIM5);
    _DIM6(p, t, DIM6); _DIM6.derivative( f, p, t, dDIM6);
    _dfunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, dDIM1, dDIM2, dDIM3, 
           dDIM4, dDIM5, dDIM6, m);
}
    

    
MAST::Solid1D6ParameterSectionProperty::PolarInertia::
...
void MAST::Solid1D6ParameterSectionProperty::PolarInertia::
operator() (const libMesh::Point& p,const Real t, Real& m) const 
{
    Real DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, offy, offz, A;
    _DIM1(p, t, DIM1);
    _DIM2(p, t, DIM2);
    _DIM3(p, t, DIM3);
    _DIM4(p, t, DIM4);
    ...
    _Afunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, A);
...
{
    Real DIM1, DIM2, DIM3, DIM4, DIM5, DIM6;
    Real dDIM1, dDIM2, dDIM3, dDIM4, dDIM5, dDIM6; 
    ...
    _Afunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, A);
    _dAfunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, dDIM1, dDIM2, 
            dDIM3, dDIM4, dDIM5, dDIM6, dA);
...
MAST::Solid1D6ParameterSectionProperty::AreaYMoment::
...
void MAST::Solid1D6ParameterSectionProperty::AreaYMoment::
operator() (const libMesh::Point& p, const Real t, Real& m) const 
{
    Real DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, off, A;
    _DIM1(p, t, DIM1);
    _DIM2(p, t, DIM2);
    _DIM3(p, t, DIM3);
    _DIM4(p, t, DIM4);
...
MAST::Solid1D6ParameterSectionProperty::AreaZMoment::
...
void MAST::Solid1D6ParameterSectionProperty::AreaZMoment::
operator() (const libMesh::Point& p, const Real t, Real& m) const 
{
    Real DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, off, A;
    _DIM1(p, t, DIM1);
...
MAST::Solid1D6ParameterSectionProperty::AreaInertiaMatrix::
AreaInertiaMatrix(const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                           Real&, Real&)> Izfunc,
                  const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                           Real&, Real&, Real&, Real&, Real&, 
                                           Real&, Real&, Real&)> dIzfunc,
                  const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                           Real&, Real&)> Iyfunc,
                  const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                           Real&, Real&, Real&, Real&, Real&, 
                                           Real&, Real&, Real&)> dIyfunc,
                  const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                           Real&, Real&)> Afunc,
                  const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                           Real&, Real&, Real&, Real&, Real&, 
...
void MAST::Solid1D6ParameterSectionProperty::AreaInertiaMatrix::
operator() (const libMesh::Point& p, const Real t, RealMatrixX& m) const 
{
    ...
    _Afunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, A);
    _Izfunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, m(0,0));
    _Iyfunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, m(1,1));
            ...
            RealMatrixX& m) const 
{
    ...
    _dAfunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, dDIM1, dDIM2, 
            dDIM3, dDIM4, dDIM5, dDIM6, dA);
    _dIzfunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, dDIM1, dDIM2, 
             dDIM3, dDIM4, dDIM5, dDIM6, m(0,0));
    _dIyfunc(DIM1, DIM2, DIM3, DIM4, DIM5, DIM6, dDIM1, dDIM2, 
             dDIM3, dDIM4, dDIM5, dDIM6, m(1,1));
