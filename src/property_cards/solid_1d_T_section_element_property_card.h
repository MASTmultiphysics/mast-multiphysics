...
#ifndef __mast__solid_1d_T_section_element_property_card__
#define __mast__solid_1d_T_section_element_property_card__
...
namespace MAST{
    namespace Solid1DTSectionProperty{
...
namespace MAST {
    ...
    class Solid1DTSectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DTSectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DTSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_T_section_element_property_card__
