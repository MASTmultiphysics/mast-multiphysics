...
#ifndef __mast__solid_1d_chan_section_element_property_card__
#define __mast__solid_1d_chan_section_element_property_card__
...
namespace MAST{
    namespace Solid1DChanSectionProperty{
...
namespace MAST {
    ...
    class Solid1DChanSectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DChanSectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DChanSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_chan_section_element_property_card__
