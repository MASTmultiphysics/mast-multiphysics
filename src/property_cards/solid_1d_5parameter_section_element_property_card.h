...
#ifndef __mast__solid_1d_5parameter_section_element_property_card__
#define __mast__solid_1d_5parameter_section_element_property_card__
...
namespace MAST {
    namespace Solid1D5ParameterSectionProperty {
...
namespace MAST {
    ...
    class Solid1D5ParameterSectionElementPropertyCard : public MAST::Solid1DSectionElementPropertyCard
    {
    public:
        Solid1D5ParameterSectionElementPropertyCard():
        MAST::Solid1DSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1D5ParameterSectionElementPropertyCard() { }
    };
}


#endif // __mast__solid_1d_5parameter_section_element_property_card__
