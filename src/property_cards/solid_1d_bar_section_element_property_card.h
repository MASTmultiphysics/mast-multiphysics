...
#ifndef __mast__solid_1d_bar_section_element_property_card__
#define __mast__solid_1d_bar_section_element_property_card__
...
namespace MAST{
    namespace Solid1DBarSectionProperty{
        ...
        void calcJ1(Real& DIM1, Real& DIM2, Real& J1);

        void calcdJ1(Real& DIM1, Real& DIM2, Real& dDIM1, Real& dDIM2, Real& dJ1);

        void calcJ2(Real& DIM1, Real& DIM2, Real& J2);

        void calcdJ2(Real& DIM1, Real& DIM2, Real& dDIM1, Real& dDIM2, Real& dJ2);
...
namespace MAST {
    ...
    class Solid1DBarSectionElementPropertyCard : public MAST::Solid1DnParameterSectionElementPropertyCard
    {
    public:
        Solid1DBarSectionElementPropertyCard():
        MAST::Solid1DnParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DBarSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_bar_section_element_property_card__
