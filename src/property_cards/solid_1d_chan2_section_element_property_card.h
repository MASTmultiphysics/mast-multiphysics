...
#ifndef __mast__solid_1d_chan2_section_element_property_card__
#define __mast__solid_1d_chan2_section_element_property_card__
...
namespace MAST{
    namespace Solid1DChan2SectionProperty{
...
namespace MAST {
    ...
    class Solid1DChan2SectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DChan2SectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DChan2SectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_chan2_section_element_property_card__
