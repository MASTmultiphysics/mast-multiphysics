...
#ifndef __mast__solid_1d_4parameter_section_element_property_card__
#define __mast__solid_1d_4parameter_section_element_property_card__
...
namespace MAST {
    namespace Solid1D4ParameterSectionProperty {
        
        class Area: public MAST::FieldFunction<Real> {
        public:
            Area(const std::function<void(Real&, Real&, Real&, Real&, 
                                          Real&)> func,
        ...
        protected:
            const std::function<void(Real&, Real&, Real&, Real&, Real&)> _func;
            const std::function<void(Real&, Real&, Real&, Real&, Real&, Real&, 
                                     Real&, Real&, Real&)> _dfunc;
        ...
        protected:
            const std::function<void(Real&, Real&, Real&, Real&, Real&)> _Afunc;
            const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                     Real&, Real&, Real&, Real&)> _dAfunc;
            const MAST::FieldFunction<Real> &_DIM1, &_DIM2, &_DIM3, &_DIM4,
                                            &_hz_offset;
        };
        ...
        protected:
            const std::function<void(Real&, Real&, Real&, Real&, 
                                     Real&)> _Izfunc, _Iyfunc, _Afunc;
            const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                     Real&, Real&, Real&, Real&)> _dIzfunc,
                                     _dIyfunc, _dAfunc;
            const MAST::FieldFunction<Real> &_DIM1, &_DIM2, &_DIM3, &_DIM4,
                                            &_hy_offset, &_hz_offset;
        };
...
namespace MAST {
    ...
    class Solid1D4ParameterSectionElementPropertyCard : public MAST::Solid1DSectionElementPropertyCard
    {
    public:
        Solid1D4ParameterSectionElementPropertyCard():
        MAST::Solid1DSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1D4ParameterSectionElementPropertyCard() { }
    };
}


#endif // __mast__solid_1d_4parameter_section_element_property_card__
