...
#ifndef __mast__solid_1d_Z_section_element_property_card__
#define __mast__solid_1d_Z_section_element_property_card__
...
namespace MAST{
    namespace Solid1DZSectionProperty{
...
namespace MAST {
    ...
    class Solid1DZSectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DZSectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DZSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_Z_section_element_property_card__
