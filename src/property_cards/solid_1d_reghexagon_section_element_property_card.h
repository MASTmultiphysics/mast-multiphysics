...
#ifndef __mast__solid_1d_reghexagon_section_element_property_card__
#define __mast__solid_1d_reghexagon_section_element_property_card__
...
namespace MAST{
    namespace Solid1DRegHexagonSectionProperty{
...
namespace MAST {
    ...
    class Solid1DRegHexagonSectionElementPropertyCard : public MAST::Solid1D1ParameterSectionElementPropertyCard
    {
    public:
        Solid1DRegHexagonSectionElementPropertyCard():
        MAST::Solid1D1ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DRegHexagonSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_reghexagon_section_element_property_card__
