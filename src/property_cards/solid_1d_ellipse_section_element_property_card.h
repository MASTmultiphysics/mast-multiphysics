...
#ifndef __mast__solid_1d_ellipse_section_element_property_card__
#define __mast__solid_1d_ellipse_section_element_property_card__
...
namespace MAST{
    namespace Solid1DEllipseSectionProperty{
...
namespace MAST {
    ...
    class Solid1DEllipseSectionElementPropertyCard : public MAST::Solid1D2ParameterSectionElementPropertyCard
    {
    public:
        Solid1DEllipseSectionElementPropertyCard():
        MAST::Solid1D2ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DEllipseSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_ellipse_section_element_property_card__
