...
#ifndef __mast__solid_1d_H_section_element_property_card__
#define __mast__solid_1d_H_section_element_property_card__
...
// H-Beam (H in Nastran)
namespace MAST{
    namespace Solid1DHSectionProperty{
...
namespace MAST {
    ...
    class Solid1DHSectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DHSectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DHSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_H_section_element_property_card__
