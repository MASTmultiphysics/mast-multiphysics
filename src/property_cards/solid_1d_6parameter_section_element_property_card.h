...
#ifndef __mast__solid_1d_6parameter_section_element_property_card__
#define __mast__solid_1d_6parameter_section_element_property_card__
...
namespace MAST {
    namespace Solid1D6ParameterSectionProperty {
        ...
        protected:
            const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                     Real&, Real&)> _func, _Afunc;
            const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                     Real&, Real&, Real&, Real&, Real&, 
                                     Real&, Real&, Real&)> _dfunc, _dAfunc;
            const MAST::FieldFunction<Real> &_DIM1, &_DIM2, &_DIM3, &_DIM4,
                                            &_DIM5, &_DIM6, 
        ...
        public:
            AreaInertiaMatrix(const std::function<void(Real&, Real&,Real&,Real&, 
                                                  Real&, Real&, Real&)> Izfunc,
                         const std::function<void(Real&, Real&, Real&, Real&, 
                                                  Real&, Real&, Real&, Real&, 
                                                  Real&, Real&, Real&, Real&, 
                                                  Real&)> dIzfunc,
                         const std::function<void(Real&, Real&, Real&, Real&, 
                                                  Real&, Real&, Real&)> Iyfunc,
                         const std::function<void(Real&, Real&, Real&, Real&, 
                                                  Real&, Real&, Real&, Real&, 
                                                  Real&, Real&, Real&, Real&, 
                                                  Real&)> dIyfunc,
        ...
        protected:
            ...
            const std::function<void(Real&, Real&, Real&, Real&, Real&, 
                                     Real&, Real&, Real&, Real&, Real&, 
                                     Real&, Real&, Real&)> _dIzfunc, _dIyfunc, 
                                     _dAfunc;
            const MAST::FieldFunction<Real> &_DIM1, &_DIM2, &_DIM3, &_DIM4,
                                            &_DIM5, &_DIM6, 
                                            &_hy_offset, &_hz_offset;
...
namespace MAST {
    ...
    class Solid1D6ParameterSectionElementPropertyCard : public MAST::Solid1DSectionElementPropertyCard
    {
    public:
        Solid1D6ParameterSectionElementPropertyCard():
        MAST::Solid1DSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1D6ParameterSectionElementPropertyCard() { }
    };
}


#endif // __mast__solid_1d_6parameter_section_element_property_card__
