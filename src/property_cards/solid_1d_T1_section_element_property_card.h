...
#ifndef __mast__solid_1d_T1_section_element_property_card__
#define __mast__solid_1d_T1_section_element_property_card__
...
namespace MAST{
    namespace Solid1DT1SectionProperty{
...
namespace MAST {
    ...
    class Solid1DT1SectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DT1SectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DT1SectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_T1_section_element_property_card__
