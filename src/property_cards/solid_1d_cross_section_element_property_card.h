...
#ifndef __mast__solid_1d_cross_section_element_property_card__
#define __mast__solid_1d_cross_section_element_property_card__
...
namespace MAST{
    namespace Solid1DCrossSectionProperty{
...
namespace MAST {
    ...
    class Solid1DCrossSectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DCrossSectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DCrossSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_cross_section_element_property_card__
