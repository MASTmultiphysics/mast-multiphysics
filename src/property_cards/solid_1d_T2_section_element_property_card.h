...
#ifndef __mast__solid_1d_T2_section_element_property_card__
#define __mast__solid_1d_T2_section_element_property_card__
...
namespace MAST{
    namespace Solid1DT2SectionProperty{
...
namespace MAST {
    ...
    class Solid1DT2SectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DT2SectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DT2SectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_T2_section_element_property_card__
