...
#ifndef __mast__solid_1d_box_section_element_property_card__
#define __mast__solid_1d_box_section_element_property_card__
...
namespace MAST{
    namespace Solid1DBoxSectionProperty{
...
namespace MAST {
    ...
    class Solid1DBoxSectionElementPropertyCard : public MAST::Solid1D4ParameterSectionElementPropertyCard
    {
    public:
        Solid1DBoxSectionElementPropertyCard():
        MAST::Solid1D4ParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DBoxSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_box_section_element_property_card__
