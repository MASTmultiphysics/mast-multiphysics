...
#ifndef __mast__solid_1d_tube_section_element_property_card__
#define __mast__solid_1d_tube_section_element_property_card__
...
namespace MAST{
    namespace Solid1DTubeSectionProperty{
...
namespace MAST {
    ...
    class Solid1DTubeSectionElementPropertyCard : public MAST::Solid1DnParameterSectionElementPropertyCard
    {
    public:
        Solid1DTubeSectionElementPropertyCard():
        MAST::Solid1DnParameterSectionElementPropertyCard() {}
        
        /*!
         *   virtual destructor
         */
        virtual ~Solid1DTubeSectionElementPropertyCard() { }
...
#endif // __mast__solid_1d_tube_section_element_property_card__
