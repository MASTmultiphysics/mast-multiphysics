...
#ifndef _mast__level_set_perimeter_output_h__
#define _mast__level_set_perimeter_output_h__
...
namespace MAST {
     ...
     *   \f[ P(\phi) \approx \int_\Omega \delta_d(phi) ~d\Omega \f], where
     *   \f$ \phi \f$ is the level set function, \f$ \delta_d(\phi) \f$ is
     *   the approximation to the Dirac delta function implemented in
     *   \p LevelSetElementBase.
     */
